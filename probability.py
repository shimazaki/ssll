...
def max_posterior(emd, t):
    ...
    lpp = -numpy.inf
    lpc = log_likelihood(y_t, theta_max, R) +\
          log_multivariate_normal(theta_max, theta_o, sigma_o)
    iterations = 0
    # Iterate the gradient ascent algorithm until convergence or failure
    #TODO consider making this a proportional criteria and cap max_iterations
    while lpc - lpp > 1e-3:
        ...
        if iterations == MAX_MP_ITERATIONS:
